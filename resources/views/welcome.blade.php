                    ...
                    <div class="item active">
                        ...
                        <div class="container">
                            <div class="carousel-caption b-slider__info">
                                <h3>TROUVEZ VOTRE RÊVE</h3>
                                <h2>{{$oneprod->name}}</h2>
                                <p>Model 2015 <span>$184,900</span></p>
                                <a class="btn m-btn" href="{{route('products.show', $oneprod->slug)}}">voir les détails<span class="fa fa-angle-right"></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="item ">
                ...
                <div class="row">
                    <div class="col-md-5 col-md-offset-2 col-sm-6 col-xs-12">
                        <div class="b-welcome__text wow fadeInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                            <h2>LE PLUS GRAND CONCESSIONNAIRE DE VOITURES EN ALGERIE</h2>
                            <h3>BIENVENUE À ACA-Achour Enterprises</h3>
